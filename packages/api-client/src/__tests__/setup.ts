...
// Load .env.test from api-client package root
config({ path: resolve(__dirname, '../../.env.test') });

// Local Supabase credentials (loaded from .env.test)
...
if (!SUPABASE_URL || !SUPABASE_ANON_KEY || !SUPABASE_SERVICE_ROLE_KEY) {
  throw new Error(
    'Missing Supabase test credentials. Make sure .env.test exists with:\n' +
