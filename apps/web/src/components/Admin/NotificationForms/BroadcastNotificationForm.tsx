/**
 * BroadcastNotificationForm Component
 *
...
export function BroadcastNotificationForm({ onSuccess, onError }: BroadcastNotificationFormProps) {
  ...
  const handleSubmit = async (data: BroadcastNotificationFormValues) => {
    try {
